 ...
 */
final class Version20190129180308 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE survey (id INT NOT NULL, title VARCHAR(800) NOT NULL, options TEXT NOT NULL, PRIMARY KEY(id))');
